...
import credly from '@images/credly.png';
    ...
    <div class="About">
      <div class="card">
        ...
        <div class="card_social">
          <a href="https://github.com/palmalion1980">
            <img src="${github}" />
          </a>
          <a href="https://www.credly.com/users/marcoleon">
            <img src="${credly}" />
          </a>
          <a href="https://codelordwillow.online/">
            <img src="${port}" />
          </a>
        </div>
      </div>
